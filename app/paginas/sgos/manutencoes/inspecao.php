...
include '../app/backend/homeBackend/sgosBackend/InspecaoEfic.php';
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card card-navy card-outline">
            ...
            <div class="card-body">
                <div class="chart">
                    <canvas id="chartInspcao" height="400" style="height: 180px; display: block; width: 304px;" width="912" class="chartjs-render-monitor"></canvas>
                </div>
            </div>
            <!-- /.card-body -->
...
<script>
    var ctx = document.getElementById('chartInspcao');
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                    ...
                    data: [
                        <?php echo $inspecaoMecanicaGeradas ?>,
                        <?php echo $inspecaoEletricaGeradas ?>
                ...
                },
                {
                    ...
                    pointHighlightStroke: 'rgba(220,220,220,1)',
                    data: [
                        <?php echo $inspecaoMecanicaGeradasFinalizadas ?>,
                        <?php echo $inspecaoEletricaGeradasFinalizadas ?>
                    ]
                }
