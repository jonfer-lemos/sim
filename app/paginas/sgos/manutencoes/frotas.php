...
include '../app/backend/homeBackend/sgosBackend/frotasEfic.php';
...
<script>
    ...
    var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['Preventivas', 'Lubrificação', 'Corretivas'],
            datasets: [{
                    label: 'Geradas',
                    ...
                    data: [
                        <?php echo $frotasMecGeradas ?>,
                        <?php echo $frotasLubGeradas ?>,
                        <?php echo $frotasCorretivasGeradas ?>
                ...
                },
                {
                    ...
                    pointHighlightStroke: 'rgba(220,220,220,1)',
                    data: [
                        <?php echo $frotasMecGeradasFinalizadas ?>,
                        <?php echo $frotasLubGeradasFinalizadas ?>,
                        <?php echo $frotasCorretivasGeradasFinalizadas ?>
                    ]
                }
